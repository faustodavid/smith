description: Smith-style Azure DevOps and GitHub discovery search via smith CLI (read-only)
---
...
Output contract:
- Return a concise answer plus source paths in `project/repository:path` or `org/repository:path`.
