...
SCENARIOS: list[Scenario] = [
    Scenario(
        key="code_grep_github_doc",
        description='smith code grep github publishing-msp-drupal8 "grafana" --path /doc --output-mode files_with_matches',
        command=[
            "smith",
            "code",
            "grep",
    ...
    Scenario(
        key="code_search_all",
        description='smith code search "grafana" --provider all --take 20',
        command=[
            "smith",
            "code",
            "search",
