...
def run_trigger_checks() -> list[str]:
    ...
    explicit_invocation_markers = [
        ...
        "smith code grep <azdo-remote-name> <project> <repo>",
        "smith code grep <github-remote-name> <repo>",
        "smith code grep <gitlab-remote-name> <repo>",
        ...
        "smith stories search <azdo-remote-name> <project> --query",
        "smith stories search <gitlab-remote-name> <repo> --query",
    ]
...
def run_behavior_checks() -> list[str]:
    ...
    command_markers = [
        ...
        "smith pipelines logs grep <github-remote-name> <repo> <id>",
        "smith pipelines logs grep <gitlab-remote-name> <repo> <id>",
        "smith stories get <azdo-remote-name> <project> <id>",
        "smith stories search <github-remote-name> <repo> --query",
        "smith stories search <gitlab-remote-name> <repo> --query",
